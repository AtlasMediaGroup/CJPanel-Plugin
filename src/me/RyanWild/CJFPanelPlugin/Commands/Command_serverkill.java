...
@CommandPermissions(source = SourceType.PLAYER, usage = "Usage: /<command>", permission = "cjpanel.kill")
public class Command_serverkill extends BukkitCommand
{
    ...
    public static void PanelAccess(final CommandSender sender, final Player target, final Command_serverkill.PanelMode mode)
    {
